...
```{r circle-plot, eval=TRUE, fig.alt="Scatterplot of y versus x for the circle dataset", fig.fullwidth=TRUE, fig.height=6, fig.width=6}
# Your code here
...
```{r all-viz, eval=TRUE, fig.alt="Grid of scatterplots", fig.fullwidth=TRUE, fig.height=10, fig.width=8}
